...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-5">
        <a href="{{route('frontend.profile')}}" class="menu-link px-5">My Profile</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{route('frontend.projects')}}" class="menu-link px-5">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{route('frontend.subscriptions')}}" class="menu-link px-5">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{route('frontend.billing')}}" class="menu-link px-5">
    ...
    <!-- <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0"> -->
        ...
        <!-- <div class="menu-sub menu-sub-dropdown w-175px py-4"> -->
            ...
            <!--begin::Menu item-->
            <!-- <div class="menu-item px-3">
                <a href="{{route('frontend.billing')}}" class="menu-link px-5">Billing</a>
            </div> -->
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <!-- <div class="menu-item px-3">
    ...
    <div class="menu-item px-5 my-1">
        <a href="{{route('frontend.settings')}}" class="menu-link px-5">Account Settings</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5">
