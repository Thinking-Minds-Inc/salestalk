...
<!--end::Menu 3-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{ route('frontend.profile') }}">
                        Overview                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                ...
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="{{ route('frontend.activity') }}">
                        Activity                    </a>
                </li>
                <!--end::Nav item-->
                    </ul>
...
<!--end::Menu 1-->            <!--end::Menu-->
    ...
    <!--begin::Body-->
    <div class="card-body overflow-hidden" bis_skin_checked="1">
        <!--begin::Chart-->
