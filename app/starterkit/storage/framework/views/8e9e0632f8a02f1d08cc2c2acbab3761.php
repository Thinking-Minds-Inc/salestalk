				...
				<div class="me-0">
					...
					<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
						...
						<div class="menu-item px-3">
							...
							<span class="ms-2" data-bs-toggle="tooltip" title="Specify a contact email to send an invitation"><?php echo getIcon('information', 'fs-7'); ?></span></a>
						</div>
						<!--end::Menu item-->
						<!--begin::Menu item-->
...
<!--end::Chat drawer-->
<?php /**PATH /Users/faizal/Sites/keenthemes/_releases/metronic_v8.2.1/laravel/metronic_laravel_v8.2.1/starterkit/resources/views/partials/drawers/_chat-messenger.blade.php ENDPATH**/ ?>