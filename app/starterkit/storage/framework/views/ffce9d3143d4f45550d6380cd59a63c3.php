	...
	<div class="row">
		...
		<div class="col-lg-7">
			...
			<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5">
				...
				<a href="<?php echo e(route('dashboard')); ?>" class="btn btn-sm btn-primary fw-bold">Try Builder</a>
			</div>
			<!--end:Layout Builder-->
		</div>
		<!--end:Col-->
...
<!--end:Dashboards menu-->
<?php /**PATH /Users/faizal/Sites/keenthemes/_releases/metronic_v8.2.1/laravel/metronic_laravel_v8.2.1/starterkit/resources/views/layout/partials/sidebar-layout/header/_menu/__layouts.blade.php ENDPATH**/ ?>