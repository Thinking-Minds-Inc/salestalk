...
<div class="card card-flush h-lg-50">
	...
	<div class="card-body pt-5">
		...
		<div class="d-flex flex-stack">
			...
			<!--end::Section-->
			<!--begin::Action-->
			<button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end"><?php echo getIcon('exit-right-corner', 'fs-2'); ?></button>
			<!--end::Action-->
		</div>
		<!--end::Item-->
		<!--begin::Separator-->
...
<!--end::LIst widget 26-->
<?php /**PATH /Users/faizal/Sites/keenthemes/_releases/metronic_v8.2.1/laravel/metronic_laravel_v8.2.1/starterkit/resources/views/partials/widgets/lists/_widget-26.blade.php ENDPATH**/ ?>