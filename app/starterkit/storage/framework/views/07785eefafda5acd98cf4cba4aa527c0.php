				...
				<tbody>
						...
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img src="<?php echo e(image('stock/600x600/img-49.jpg')); ?>" class="" alt="" />
								</div>
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img src="<?php echo e(image('stock/600x600/img-40.jpg')); ?>" class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img src="<?php echo e(image('stock/600x600/img-39.jpg')); ?>" class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img src="<?php echo e(image('stock/600x600/img-47.jpg')); ?>" class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img src="<?php echo e(image('stock/600x600/img-48.jpg')); ?>" class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
...
<!--end::Table widget 14-->
<?php /**PATH /Users/faizal/Sites/keenthemes/_releases/metronic_v8.2.1/laravel/metronic_laravel_v8.2.1/starterkit/resources/views/partials/widgets/tables/_widget-14.blade.php ENDPATH**/ ?>